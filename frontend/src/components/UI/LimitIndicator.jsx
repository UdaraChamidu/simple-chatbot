...
export default function LimitIndicator({ count, max }) {
  ...
  return (
    <div className="flex items-center gap-3 bg-gray-100 dark:bg-white/5 px-2 md:px-4 py-1.5 md:py-2 rounded-full border border-gray-200 dark:border-white/5 hover:bg-gray-200 dark:hover:bg-white/10 transition-colors cursor-help group">
